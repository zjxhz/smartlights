...
-(void)setBrightness:(CGFloat)bright {
	...
	[delegate colorPickerDidChangeSelection:self state:0];
}
...
-(void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event {
   ...
   //Lazily load loupeLayer
	...
	[delegate colorPickerDidChangeSelection:self state:COLOR_BEGIN];
...
-(void)touchesMoved:(NSSet *)touches withEvent:(UIEvent *)event {
	...
	selection = circlePoint;
	[delegate colorPickerDidChangeSelection:self state:COLOR_MOVED];
	[self updateSelectionLocation];
}
-(void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event {
	...
	selection = circlePoint;
	[delegate colorPickerDidChangeSelection:self state:COLOR_ENDED];
    [self updateSelectionLocation];
    [loupeLayer disapear];
}
