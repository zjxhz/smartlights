...
- (void)setupTableView {
    ...
    if ([[UIDevice currentDevice].systemVersion intValue] <7) {
        CGRect frame = _mTableView.frame;
        [_mTableView setFrame:CGRectMake(frame.origin.x, frame.origin.y-44, frame.size.width, frame.size.height+44)];
    }
}
...
- (void)keyboardWillShow:(NSNotification *)notification {
    ...
    CGFloat keyboardHeight = 216;//[[[notification userInfo] objectForKey:UIKeyboardBoundsUserInfoKey] CGRectValue].size.height;
